...
class Luta
{
    ...
    function __construct() // Instacia a classe definindo o estado padrão da luta como não aprovada
    {
        $this->aprovada = false;
    }
    ...
    { // Marca uma luta entre o lutador desafiado e o desafiante, se atender as condições
    ...
    { // Inicia a luta anteriomente marcada, caso tenha sido aprovada
        if (!$this->getAprovada()) {
